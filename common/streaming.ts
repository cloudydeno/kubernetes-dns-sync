// patched vendoring of https://github.com/danopia/deno-kubernetes_apis/blob/main/lib/streaming.ts

import * as MetaV1 from "https://deno.land/x/kubernetes_apis@v0.1.0/builtin/meta@v1/structs.ts";
import { WatchEvent, WatchEventError, WatchEventBookmark } from "https://deno.land/x/kubernetes_apis@v0.1.0/common.ts";
